...
Template.Edit_Contact_Page.onCreated(function onCreated() {
  ...
  const createContext = ContactSchema.namedContext('Edit_Contact_Page');
...
Template.Edit_Contact_Page.events({
  'submit .contact-data-form'(event, instance) {
    ...
    const updatedContactData = { firstName, lastName, address, phone, email };
    ...
    if (instance.context.isValid()) {
      const id = Contact.update(FlowRouter.getParam('_id'), { $set: updatedContactData });
